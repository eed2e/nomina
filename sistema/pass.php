...
if (!empty($_POST)) {
  ...
  if (empty($_POST['pass']) || empty($_POST['npass']) || empty($_POST['cnpass'])) {
    ...
    $sqli= mysqli_query($conexion, "SELECT * FROM usuarios WHERE id = $id");
    ...
    if($pass != $x['pass']){
        ...
        $sql_update = mysqli_query($conexion, "UPDATE usuarios SET pass = '$npass' WHERE id = $id");
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="" action="" method="post">
            ...
            <a href="usuarios.php" class="btn btn-outline-danger">Regresar</a>
          </form>
        </div>
      </div>
    </div>
