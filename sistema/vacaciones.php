        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <br>
                    <h4 class="modal-title text-center" id="myModalLabel">Editar Vacaciones</h4>
                    ...
                    <form action="registrar_vacaciones.php" method="post" class="md-float-material form-material">   
                        <div class="auth-box card">
                            <div class="card-block" class="row">
                               ...
                               <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="empleado_editar" name="empleado_editar" style="border-radius:15px;"> 
                                    <?php
                                        include "../conexion.php";  
                                            $query = mysqli_query($conexion, "SELECT * FROM empleados");
                                            $result = mysqli_num_rows($query);  
                                ...
                                <div class="form-group form-primary" class="col">
                                    <label for="fecha">
                                        <br>
                                        <H6>Inicio de Vacaciones:</H6>                                 
                                         <input center type="date" name="fecha_ieditar" id="fecha_ieditar" stylerequired style="border-radius:15px;" class="form-control">
                                ...
                                <div class="form-group form-primary" class="col">
                                    <label for="fecha">
                                        ...
                                        <H6>Fin de Vacaciones:</H6>                                 
                                         <input center type="date" name="fecha_feditar" id="fecha_feditar" stylerequired style="border-radius:15px;" class="form-control">
                                     </label>
                                 </div>
...
<script type="text/javascript">
        ...
        function editar_empleado(id,nombre,apellido_paterno,apellido_materno,fecha_i,fecha_f)

            {
                alert(id);
                
                document.getElementById('empleado_editar').value = id;
                document.getElementById('fecha_ieditar').value = fecha_i;
                document.getElementById('fecha_feditar').value = fecha_f;
            }
</script>